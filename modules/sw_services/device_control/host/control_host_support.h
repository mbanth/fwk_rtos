...
#if USE_HID
// HID transaction size is up tp 1024 bytes, and one byte is used for the report ID
// Transaction size is limited to 256 bytes as higher values have not been tested
#define HID_TRANSACTION_MAX_BYTES 256
